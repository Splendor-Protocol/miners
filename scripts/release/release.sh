...
#
# In this script you are going to find the process of releasing openminers.
#
# This script needs:
...
#   - Tag in Github repo: https://github.com/opentensor/miners/tags
#   - Release in Github: https://github.com/opentensor/miners/releases
...
function help(){
    ...
    echo \ \  $0
    echo
    echo This script release an openminers version.
    echo
...
#  - VERSION file exists
#  - __version__ exists inside file 'openminers/__init__.py'
#  - Both versions have the expected format and are the same

VERSION_FILENAME='VERSION'
CODE_WITH_VERSION='openminers/__init__.py'
